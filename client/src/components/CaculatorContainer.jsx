              ...
              <div class="py-12 bg-white rounded-xl w-full">
                ...
                <div className="flex flex-wrap justify-end lg:justify-start ml-1 pb-14 mb-14 xl:pb-28 xl:mb-24 border-b border-black border-opacity-10">
                  <div className="flex flex-wrap w-full lg:w-8/12 xl:w-full px-4 mb-10 lg:mb-0">
                    ...
                    <div className="w-full md:w-1/2 px-4 mb-4 pl-6 ">
                      <div className="lg:max-w-md ml-10">
                        <div className="mb-8">
                          <label className="block mb-4 text-lg text-darkBlueGray-400 text-left">
                            Your Age:&nbsp;
                            <Tooltip text="The younger the better!">
                              <span className="text-blue-500 cursor-pointer">
                                <img src="./noun-question-mark-2660318.svg" className="w-6 h-6 object-contain"/>
                              </span>
                            </Tooltip>
                          </label>
                          <input
                    ...
                    <div className="pt-11 pb-11 bg-purple-50 rounded-md">
                      ...
                      <div className="px-10 pb-0">
                        ...
                        >
                          ...
                          <span className="text-red-500 font-extrabold"> out of the red.</span>
                        </h2>
                        <p className="mb-5 text-sm text-black font-heading font-small text-left max-w-lg">
                          There are a few seps you could take to jumpstart your retirement savings. See below how small tweaks to your spending habits can have a big effect. 
                        </p>
                      </div>
